...
<body background="fondo/azul.jpg"> 
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<h1 style="text-align: center;">Reporte de Boletas Por Intérvalo de Tiempo</h1>
        <form action="SBol">
		     <div style="margin-top:30px;margin-left: 20%;margin-bottom:30px; width: 200px; top: 0px; right: 0px; float: left"
				 class="form-group">
						<label for="fecha1">primera fecha</label> <input
							type="date" class="form-control" id="fecha"
							placeholder="YYYY/MM/DD"
							name="fechainicial"  >
					</div>
					<div style="margin-top:30px;margin-left: 10%;margin-bottom:30px; width: 200px; top: 0px; right: 0px; float: left"
				 class="form-group">
						<label for="fecha2"> última fecha </label> <input
							type="date" class="form-control" id="fecha"
							placeholder="YYYY/MM/DD"
							name="fechafinal" >
					</div>
					<br>
		<button style="margin-top:30px;margin-left: 10%;margin-bottom:30px; width: 200px; top: 0px; right: 0px; float: left"
				 type="submit" class="btn btn-warning" name="btnes" value="rf">Filtrar</button>
	</form>	
	<br>
	<br>
