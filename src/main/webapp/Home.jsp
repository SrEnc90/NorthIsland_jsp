	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="Conocenos.jsp">Conócenos</a></li>
		...
		<section>
			...
			<section style="background-color: white;">
				...
				<figure  style="border-radius:6px;">
					...
					<label>LACOSTE Vestido Mujer Piqué Manga Corta Rayado</label>
				</figure>
				...
				<figure style="border-radius:6px;">
					...
					<label>Adribras Polo Con Cuello Essentials Aeroready Piqué logo Pequeño </label>
				</figure>
